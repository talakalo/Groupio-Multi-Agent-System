...
// Test data (sourced from factories)
const TEST_ADMIN = createAdminCredentials();

// Mock data sourced from centralized factories
const MOCK_SYSTEM_HEALTH = createSystemHealth();
const MOCK_DASHBOARD_STATS = createDashboardStats();
const MOCK_PENDING_CONTRACTORS = createPendingContractors();
const MOCK_ESCALATIONS = createEscalations();
