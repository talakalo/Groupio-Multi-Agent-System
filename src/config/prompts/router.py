...
- viral_invite_query: User asks about sharing an offer with neighbours, getting an invite link,
  or receiving a discount from inviting others
- building_social_proof: User asks how many similar buildings joined a deal,
  or wants social proof data about neighbouring buildings
- influencer_campaign: Admin-triggered request about top resident connectors, influence scores,
  or ₪500 credit awards for top inviters
...
When last_agent_handoff is provided (appended below), prefer routing to the suggested intent or agent \
when the user message is a clear follow-up (e.g. "what about price?", "yes", "the second one").
