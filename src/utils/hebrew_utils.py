...
HEBREW_STOPWORDS = {
    "של", "את", "הוא", "היא", "זה", "זו", "אני", "הם", "הן",
    "אנחנו", "אתה", "את", "לא", "כן", "על", "עם", "גם", "או",
    "אם", "כי", "אבל", "רק", "כל", "מה", "מי", "איך", "למה",
    "כמה", "מתי", "איפה", "שם", "פה", "יש", "אין", "עוד",
    "בין", "בגלל", "לפני", "אחרי", "עד", "מן", "אל",
}
...
def detect_legal_keywords(text: str) -> bool:
    ...
    legal_keywords_he = [
        "עורך דין", "תביעה", "בית משפט", "משפטי", "נזיקין",
        "פיצויים", "חוק", "תלונה", "משטרה", "רשות",
    ]
    legal_keywords_en = [
        "lawyer", "lawsuit", "court", "legal action", "sue",
        "attorney", "compensation", "police", "complaint",
    ]
